...
public partial class IndexCorporation
{
    ...
    private async Task ShowModalAsync(int id = 0, bool isEdit = false)
    {
        ...
        if (isEdit)
        {
            ...
            dialog = _dialogService.Show<EditCorporation>($"Editar Corporacion", parameters, options);
        }
        else
        {
            dialog = _dialogService.Show<CreateCorporation>($"Nueva Corporacion", options);
        }
    ...
    private async Task ShowDetailsAsync(int id)
    {
        ...
        dialog = _dialogService.Show<DetailsCorporation>($"Detalle Corporacion", parameters, options);
